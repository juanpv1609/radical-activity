                        ...
                        <v-row>
                            <v-col cols="12" md="3" >
                                    ...
                                    <v-sheet
                                        ...
                                        ></v-img>
                                        <v-icon v-else size="160">mdi-account</v-icon>
                                    </v-sheet>
                                    <v-file-input
                                            small-chips
                                            accept="image/*"
...
export default {
    data() {
        return {
            ...
            Rules : {
                ...
                ci: [
                    v => !!v || 'Este campo es requerido',
                    v => v.length == 10 || 'Este campo debe tener 10 caracteres',
                ],
                email: [
                    v => !!v || 'Este campo es requerido',
    ...
    created() {
        ...
        this.persona.apellido='PERUGACHI';
        this.persona.ci='1721731337';
        this.persona.email='juanpv1609@gmail.com';
        this.persona.pais_id=1;
        this.persona.nacionalidad_id=1;
        this.persona.telefono='0983078906';
        this.initialData();
    },
    methods: {
        add() {
      ...
      deleteEducacion(el) {
         ...
         addUser() {
            ...
            this.persona = {};
            this.persona.password = "R@dical2021";
            this.update = false;
            this.dialog = true;
        },
        createPerson() {
